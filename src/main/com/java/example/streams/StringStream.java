...
public class StringStream
{
    public static void main(String[] args)
    {
        ...
        List<String> myName = Stream.of(myInfo.split(",")).map(elem -> elem).collect(Collectors.toList());

        System.out.println("split a comma separated String into a list of String: " + myName);
